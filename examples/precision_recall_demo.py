...
def demonstrate_precision_recall_at_k():
    ...
    print("-" * 45)
    print(f"{'SVD':<10} {svd_result['precision_at_k']:<15.4f} {svd_result['recall_at_k']:<12.4f} {svd_result['num_users']:<8}")
    print(f"{'KNN':<10} {knn_result['precision_at_k']:<15.4f} {knn_result['recall_at_k']:<12.4f} {knn_result['num_users']:<8}")
    ...
    if svd_result['recall_at_k'] > knn_result['recall_at_k']:
        print(f"🏆 SVD has better Recall@10 (+{svd_result['recall_at_k'] - knn_result['recall_at_k']:.4f})")
    else:
        print(f"🏆 KNN has better Recall@10 (+{knn_result['recall_at_k'] - svd_result['recall_at_k']:.4f})")
...
def demonstrate_function_features():
    ...
    """
    print("\n🛠️ DEMONSTRATION: Function Features and Edge Cases")
    print("=" * 60)
    ...
    print("\n⚠️ Scenario 4: No Relevant Items")
    print("-" * 35)
